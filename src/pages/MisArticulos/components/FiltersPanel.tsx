  ...
  return (
    ...
    >
      ...
      <div className="col-span-2">
        ...
        >
          <option value="">Todos</option>
          <option value="true">Borrado</option>
          <option value="false">No Borrado</option>
        </select>
      </div>
      ...
      <div className="col-span-2">
        ...
        <input
          ...
          value={filters.proyecto_nombre || ''}
          onChange={(e) => onFilterChange('proyecto_nombre', e.target.value)}
          onKeyDown={(e) => e.key === 'Enter' && onApplyFilters()}
        />
      </div>
