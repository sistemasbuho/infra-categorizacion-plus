...
import { Colaborador, TipoRecurso } from '../services/asignacionesRequest';
...
export const AsignarFormulario = ({
  ...
  const recursoLabel = tipoRecurso === 'redes' ? 'redes' : 'artículos';
        ...
        {activeTab === 'usuario' ? (
          <div className="space-y-6">
            ...
            >
              ...
              >
                Asigna {recursoLabel} a un usuario específico
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="group">
                ...
                <input
                  ...
                  placeholder={`Número de ${recursoLabel}`}
                  style={{
          ...
          <div className="space-y-6">
            ...
            >
              ...
              >
                Asigna {recursoLabel} por rango de fechas
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="group">
                ...
                >
                  <FaHashtag className="w-4 h-4 text-purple-500" />#{' '}
                  {recursoLabel}
                </label>
                <input
                  type="number"
